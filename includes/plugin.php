...
final class Plugin {
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'js Addon', 'js-addon' ) . '</strong>',
			'<strong>' . esc_html__( 'Elementor', 'js-addon' ) . '</strong>'
		);
	...
	public function init() {
		...
		add_action( 'elementor/widgets/register', [ $this, 'custom_register_widgets' ] );
	 ...
	 */
	public function custom_register_widgets( $widgets_manager ) {
